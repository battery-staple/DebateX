...
fun SectionViewModel(sectionModelFetcher: DataFetcher<SectionModel>): SectionViewModel<*> =
...
sealed class SectionViewModel<T : SectionModel>(onMainPageAtStart: Boolean = true) :
    ViewModel<T>() {
...
sealed class CardSectionViewModel<T : Model, U : ViewModel<out T>>(
...
class SpeechesSectionViewModel(
...
class SettingsSectionViewModel(override val modelFetcher: SectionFetcher<SettingsSectionModel>) :
