...
//        get() = listOf(EventsSectionModel(listOf(EventModel(DebateFormat.LincolnDouglas, pages = listOf(TimePageModel("a", "b", TimerModel(1.seconds, TimerCountStrategy.CountDown),
//            OneVOneSpeaker.Aff
//        ))))))
//}
