...
data class EventTags(
    ...
    override fun toString(): String {
        return "${country?.representableName}, " +
                ...
                "${region?.representableName}"
    }

    override fun iterator(): Iterator<EventVariant> =
        listOfNotNull<EventVariant>(country, ageGroup, organization, region).iterator()
...
enum class Region(override val representableName: String) : EventVariant {
    National("Nationals"),
    State("States"),
    Local("Local")
}
