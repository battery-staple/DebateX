...
//
//internal abstract class SettingsProxy(val settingsAccess: SettingsAccess) { //TODO: Generic Accessor<Settings> ?
//
...
//
//        init {
//            require(_setting in settingsAccess.allSettings)
//        }
//
...
//
//class SettingsTest {
//    internal object Proxy : SettingsProxy(SettingsAccess(MockSettings())) {
//        val countStrategy get() = SettingProxy(settingsAccess.countStrategy)
//        val playSoundOnComplete get() = SettingProxy(settingsAccess.playSoundOnComplete)
//
